...
const Appdetail = ({ allAppsfetch }) => {
    ...
    const toggle=(id)=>{
        ...
        toast(<div><h1>Install Successfully !</h1></div>)
    }
        ...
        <>
            <div className='border-b-1'>
                <div className= 'text-center lg:text-left px-3 lg:flex items-center gap-6 mt-8 mb-9'>
                    <img className='mx-auto mb-3 lg:w-[315px]' src={eachapp.image} alt="" />
                    <div className=''>
                        <div className='border-b-[1px] lg:w-[700px] border-[#001931]'>
                            <h1 className='font-bold lg:text-[40px] mb-2 '>{eachapp.title}</h1>
                        ...
                        <div className='flex items-center gap-6 mt-4 '>
                            <div>
                                ...
                                <p >Downloads</p>
                                <h1 className='font-extrabold text-[20px] lg:text-[40px]'>{eachapp.downloads}M</h1>
                            </div>
                            <div className='mb-1'>
                                <FaStar className='mx-auto  lg:mx-0 text-[#FF8811] text-[35px] mt-1 mb-2'></FaStar>
                                <p>Average Ratings</p>
                                <h1 className='font-extrabold text-[20px] lg:text-[40px]'>{eachapp.ratingAvg}</h1>
                            </div>
                            <div>
                                <TbFileLike className='mx-auto  lg:mx-0 text-[#9F62F2] text-[35px] mt-1  mb-2'></TbFileLike>
                                <p>Total Reviews</p>
                                <h1 className='font-extrabold text-[20px] lg:text-[40px]'>{eachapp.reviews}K</h1>
                            </div>
                        </div>
